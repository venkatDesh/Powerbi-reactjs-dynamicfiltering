  ...
  render() {
    ...
    return (
      <div id="page-container" className="container">
        ...
        <Banner appTitle="Power BI-React  Embedding" >
        ...
        <Switch>
          ...
          <Route path="/qna/:id?" render={() => <ViewQna app={this} />} />
        </Switch>
